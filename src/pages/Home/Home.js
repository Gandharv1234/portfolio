        ...
        <Row>
          <Col>
            <span className={`${styles.textWhite} ${styles.headingThree}`}>
              Software Engineer, Front-End Developer, College Student
            </span>
          </Col>
        </Row>
        <Row>
          <Col>
            <a href="https://github.com/Gandharv1234" target="_blank_">
              <FaGithubSquare className={styles.icon} />
            </a>
          </Col>
          <Col>
            <a
              href="https://www.linkedin.com/in/gandharv-kumar-104b51202/"
              target="_blank_"
            >
      ...
      <section id="skills" className="skills section-bg">
        <div className="container" data-aos="fade-up">
          <div className="section-title">
            ...
            <p>
              <centre>                
                <b>• Languages/Technologies:</b> Html, CSS, JavaScript, C, C++, Java
                <br />
                <b>• Lib/Frameworks:</b> Bootstrap,
                <br />
                <b>• Database:</b> MySQL
                <br />
                <b>• Tools:</b> Github, VsCode
                <br />
